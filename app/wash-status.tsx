...
export default function WashStatusScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerText}>Wash Status</Text>
      </View>
      ...
      <ScrollView style={styles.orderList}>
        {orders.map((order, index) => (
          <TouchableOpacity 
            ...
            onPress={() => router.push(`/wash-details/${order.id}`)} // Navigate to Wash Details
          >
