...
export default function WashDetailsScreen() {
  ...
  const handlePassToDry = () => {
    Alert.alert("Alert", "Order moved to Drying Stage", [
      {
        text: "OK",
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Pass to Dry Button */}
      <TouchableOpacity style={styles.button} onPress={handlePassToDry}>
        <Text style={styles.buttonText}>Pass to Dry</Text>
      </TouchableOpacity>
    </View>
  );
}
